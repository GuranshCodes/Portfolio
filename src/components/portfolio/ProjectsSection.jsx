...
const PROJECTS = [
  {
    ...
    description: 'A custom Excel calculator for my dad that converts kilograms to pounds. Streamlines invoice creation with instant conversions, saving time and reducing errors in manual calculations.',
    techStack: ['EXCEL', 'VBA'],
    status: 'Done',
    links: [{ label: 'View on GitHub', url: 'https://github.com/GSDhaliwal05/Excel-Formulas', type: 'github' }],
  },
  {
    title: 'Health Website',
    description: 'A health-focused informational website created for a school project. Provides valuable information on nutrition, exercise, and wellness tips, designed to educate and promote healthy living among students.',
    techStack: ['HTML', 'CSS', 'JS'],
    status: 'Done',
    links: [{ label: 'View on GitHub', url: 'https://github.com/GSDhaliwal05/Health-Website-7OB', type: 'github' }],
  },
  {
    title: 'Math Website',
    description: 'An interactive mathematics learning platform with step-by-step tutorials, practice problems, and interactive quizzes. Built to make learning math engaging and accessible for all ages.',
    techStack: ['HTML', 'CSS', 'JS'],
    status: 'Done',
    links: [{ label: 'View on GitHub', url: 'https://github.com/GSDhaliwal05/Math-Website-7OB', type: 'github' }],
  },
  {
    title: 'Portfolio Website',
    description: "The site you're viewing right now, built to showcase my projects, skills, and experience as a developer. Features responsive design and smooth animations.",
    techStack: ['REACT', 'CSS', 'JS'],
    status: 'In Progress',
    links: [{ label: 'View on GitHub', url: 'https://github.com/GSDhaliwal05/Portfolio', type: 'github' }],
  },
  {
    title: 'Gator Swamp',
    ...
    status: 'Done',
    links: [
      { label: 'View Website', url: 'https://861250.wixsite.com/snackverse', type: 'external' },
